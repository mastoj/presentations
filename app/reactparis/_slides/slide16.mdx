import Globe from '@/assets/images/nextecom/globe.png';
...
<Link href="/demos/i18n" target="_blank">Middleware demo</Link>

</CentralContent>
</Column>
<Column className="flex justify-center items-center h-full bg-white">
