...
export const NdcCopenhagen2025Slides = ({ initialSlide }: SlideProps) => {
  const presentationUrl = `https://presentations.2mas.xyz/ndccopenhagen/2025`;
  ...
  const slides: SlideDefinition[] = [
    () => (
      <TitleSlide
        ...
        presentationSlug="ndccopenhagen/2025"
      />
    ),
    c(Slide1),
    c(SlideVideo),
